...
def triangle(x, y, z): # definisco funzione triangle
    # creo un triangolo
    line1 = pygame.draw.line(screen, Giallo, (x), (y), 2)
    line2 = pygame.draw.line(screen, Giallo, (y), (z), 2)
    line3 = pygame.draw.line(screen, Giallo, (z), (x), 2)
...
while 1: 
    ...
    pygame.draw.line(screen, Giallo, (x2, y2), (x3, y3), 2)
    pygame.draw.line(screen, Giallo, (x2, y2), (x4, y4), 2)
    pygame.draw.line(screen, Giallo, (x3, y3), (x5, y5), 2)
    pygame.draw.line(screen, Giallo, (x4, y4), (x5, y5), 2)
    pygame.draw.line(screen, Giallo, (x4, y4), (x3, y3), 2)

    # disegno le linne del secondo braccio (colore cordinate spessore)
    
    pygame.draw.line(screen, Giallo, (x6, y6), (x7, y7), 2)
    pygame.draw.line(screen, Giallo, (x6, y6), (x8, y8), 2)
    pygame.draw.line(screen, Giallo, (x7, y7), (x9, y9), 2)
    pygame.draw.line(screen, Giallo, (x8, y8), (x9, y9), 2)
    pygame.draw.line(screen, Giallo, (x8, y8), (x7, y7), 2)
